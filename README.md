...
<table>
  <tr>
    ...
    <td width="75%">
      <h3 align="center">GoSnap - High Performance URL Shortener</h3>
      <p align="center">
        A production-ready <strong>Full-Stack Solution</strong> (REST API + Desktop GUI) built with <strong>Clean Architecture</strong>.
        Engineered for high concurrency using <strong>Worker Pools</strong>, <strong>Redis</strong> caching, and <strong>PostgreSQL</strong>.
      </p>
      <p align="center">
        <strong> Key Technical Features:</strong>
        <br />
        Async Processing • Graceful Shutdown • Rate Limiting • Fyne GUI
      </p>
      <p align="center">
        ...
        <a href="https://echo.labstack.com/">
          <img src="https://img.shields.io/badge/Echo_v4-00ADD8?style=flat-square&logo=go&logoColor=white" alt="Echo Framework" />
        </a>
        <a href="https://fyne.io/">
          <img src="https://img.shields.io/badge/Fyne_GUI-2D3748?style=flat-square&logo=linux&logoColor=white" alt="Fyne" />
        </a>
